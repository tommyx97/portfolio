...
export const AboutSection = ({
  ...
  return <section id="chi-sono" className="section-with-nav relative w-full min-h-screen bg-[#000000] text-white overflow-hidden flex items-center about-section">
