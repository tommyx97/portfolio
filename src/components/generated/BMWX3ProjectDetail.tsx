    ...
    fontFamily: 'Montserrat, sans-serif'
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        scale: heroScale
          ...
          <img src={images.heroBackground} alt="BMW X3 in brutalist architecture with dramatic lighting" className="hero-image w-full h-full object-cover" />
          ...
          duration: 1
            ...
            <figure className="relative w-full overflow-hidden bg-zinc-900/30 border border-white/5">
              ...
              paddingBottom: `${9 / 21 * 100}%`
                ...
                <img src={images.visualDirectionHero} alt="BMW X3 visual direction and concept" className="project-image absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            delay: 0
              ...
              paddingBottom: `${3 / 4 * 100}%`
                ...
                <img src={images.visualDirectionSupport1} alt="BMW X3 visual direction detail 1" className="gallery-image absolute inset-0 w-full h-full object-cover" />
            ...
            delay: 0.15
              ...
              paddingBottom: `${3 / 4 * 100}%`
                ...
                <img src={images.visualDirectionSupport2} alt="BMW X3 visual direction detail 2" className="gallery-image absolute inset-0 w-full h-full object-cover" />
          ...
          duration: 0.9
            ...
            <figure className="relative w-full overflow-hidden group">
              ...
              paddingBottom: `${9 / 16 * 100}%`
                ...
                <img src={images.galleryHero} alt="BMW X3 Full Body Cinematic Mood" className="gallery-image absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
            ...
            delay: 0
              ...
              paddingBottom: `${5 / 4 * 100}%`
                ...
                <img src={images.galleryImage1} alt="Design Language — Frontal Perspective" className="gallery-image absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-500" />
            ...
            delay: 0.15
              ...
              paddingBottom: `${5 / 4 * 100}%`
                ...
                <img src={images.galleryImage2} alt="Dettaglio Ruota — Texture e Materiali" className="gallery-image absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-500" />
                <div className="absolute inset-0 border border-white/0 group-hover:border-[#aec7e9]/30 transition-colors duration-500" style={{
            ...
            delay: 0.3
              ...
              paddingBottom: `${5 / 4 * 100}%`
                ...
                <img src={images.galleryImage3} alt="Contesto Urbano — Urban Minimalism" className="gallery-image absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-500" />
                <div className="absolute inset-0 border border-white/0 group-hover:border-[#aec7e9]/30 transition-colors duration-500" style={{
        ...
        <div className="max-w-[1800px] mx-auto px-8 sm:px-12 lg:px-20">
          ...
          duration: 1
            ...
            delay: 0 * 0.05
              ...
              <img src={images.socialGrid1} alt="BMW X3 campaign asset 1" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
            ...
            delay: 1 * 0.05
              ...
              <img src={images.socialGrid2} alt="BMW X3 campaign asset 2" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" />
            </motion.figure>
            ...
            delay: 2 * 0.05
              ...
              <img src={images.socialGrid3} alt="BMW X3 campaign asset 3" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
            ...
            delay: 3 * 0.05
              ...
              <img src={images.socialGrid4} alt="BMW X3 campaign asset 4" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" />
            </motion.figure>
            ...
            delay: 4 * 0.05
              ...
              <img src={images.socialGrid5} alt="BMW X3 campaign asset 5" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
            ...
            delay: 5 * 0.05
              ...
              <img src={images.socialGrid6} alt="BMW X3 campaign asset 6" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" />
            </motion.figure>
            ...
            delay: 6 * 0.05
              ...
              <img src={images.socialGrid7} alt="BMW X3 campaign asset 7" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
            ...
            delay: 7 * 0.05
              ...
              <img src={images.socialGrid8} alt="BMW X3 campaign asset 8" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
            ...
            delay: 8 * 0.05
              ...
              <img src={images.socialGrid9} alt="BMW X3 campaign asset 9" className="social-grid-image absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" style={{
