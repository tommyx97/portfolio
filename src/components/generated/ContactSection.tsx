...
const contactInfo = [{
  ...
  mpid: "05d60c21-af9f-4715-9b73-d1f45656e398"
}, {
  ...
  mpid: "a885877d-f114-403e-8d5a-00cf1d3ab8ca"
}, {
  id: 'contact-linkedin',
  icon: Linkedin,
  label: 'LinkedIn',
  ...
  mpid: "6ec9b4d0-9ff0-45b7-ab74-dcc290609160"
}] as const;
export const ContactSection = ({
  ...
  return <SortableContainer dndKitId="afa5b9ff-c8fa-45f8-ad25-853437270a60" containerType="regular" prevTag="section" className="relative w-full min-h-screen bg-black text-white flex items-center justify-center overflow-hidden" data-magicpath-id="0" data-magicpath-path="ContactSection.tsx">
      {/* Background ambient gradient */}
      <SortableContainer dndKitId="33592fab-dc8a-4feb-bd53-a2f9f5b0425a" containerType="regular" prevTag="div" className="absolute inset-0 z-0" data-magicpath-id="1" data-magicpath-path="ContactSection.tsx">
      ...
      {/* Content Container */}
      <SortableContainer dndKitId="43065a18-1aa0-4717-868d-d51e93e414cc" containerType="regular" prevTag="div" className="relative z-10 w-full max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-20 py-20 lg:py-32" data-magicpath-id="3" data-magicpath-path="ContactSection.tsx">
        
        {/* Header */}
        <SortableContainer dndKitId="e5fc2d6e-49d2-4066-9606-4ec0eade6012" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
        ...
        {/* Main content grid */}
        <SortableContainer dndKitId="a383c141-bd1a-440f-a853-c8db91c311e0" containerType="regular" prevTag="div" className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start" data-magicpath-id="8" data-magicpath-path="ContactSection.tsx">
          
          {/* Left: Message */}
          <SortableContainer dndKitId="eaf2e7ae-6519-4645-b1c6-a9640f8fd147" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          x: -40
        }} whileInView={{
          opacity: 1,
          ...
          delay: 0.2
            ...
            <SortableContainer dndKitId="38836fbf-1fce-407d-b818-ca335454423a" containerType="regular" prevTag="div" className="space-y-6" data-magicpath-id="10" data-magicpath-path="ContactSection.tsx">
            ...
            {/* Additional info */}
            <SortableContainer dndKitId="80342129-dced-4145-9058-6ea11c96befc" containerType="regular" prevTag="div" className="pt-4" data-magicpath-id="16" data-magicpath-path="ContactSection.tsx">
          ...
          <SortableContainer dndKitId="b9968eab-6f21-4637-b18c-2870f9185c72" containerType="collection" prevTag="motion.div" initial={{
          opacity: 0,
          x: 40
        }} whileInView={{
          opacity: 1,
        ...
        <SortableContainer dndKitId="5e32fd52-da9f-49f6-8547-eb9b942d688d" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0,
        scaleX: 0
      }} whileInView={{
        opacity: 1,
        ...
        {/* Footer text */}
        <SortableContainer dndKitId="dd2ff2c6-7dc1-49b4-a416-9ca965320c14" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
